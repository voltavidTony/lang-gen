...
RPO_CONTENT = {
    ...
    "${activation_duration}block.minecraft.acacia_button": "block.minecraft.acacia_button",
    "${activation_duration}block.minecraft.acacia_pressure_plate": "block.minecraft.acacia_pressure_plate",
    "${activation_duration}block.minecraft.bamboo_button": "block.minecraft.bamboo_button",
    "${activation_duration}block.minecraft.bamboo_pressure_plate": "block.minecraft.bamboo_pressure_plate",
    "${activation_duration}block.minecraft.birch_button": "block.minecraft.birch_button",
    "${activation_duration}block.minecraft.birch_pressure_plate": "block.minecraft.birch_pressure_plate",
    "${activation_duration}block.minecraft.cherry_button": "block.minecraft.cherry_button",
    "${activation_duration}block.minecraft.cherry_pressure_plate": "block.minecraft.cherry_pressure_plate",
    "${activation_duration}block.minecraft.crimson_button": "block.minecraft.crimson_button",
    "${activation_duration}block.minecraft.crimson_pressure_plate": "block.minecraft.crimson_pressure_plate",
    "${activation_duration}block.minecraft.dark_oak_button": "block.minecraft.dark_oak_button",
    "${activation_duration}block.minecraft.dark_oak_pressure_plate": "block.minecraft.dark_oak_pressure_plate",
    "${activation_duration}block.minecraft.detector_rail": "block.minecraft.detector_rail",
    "${activation_duration}block.minecraft.heavy_weighted_pressure_plate": "block.minecraft.heavy_weighted_pressure_plate",
    "${activation_duration}block.minecraft.jungle_button": "block.minecraft.jungle_button",
    "${activation_duration}block.minecraft.jungle_pressure_plate": "block.minecraft.jungle_pressure_plate",
    "${activation_duration}block.minecraft.lectern": "block.minecraft.lectern",
    "${activation_duration}block.minecraft.light_weighted_pressure_plate": "block.minecraft.light_weighted_pressure_plate",
    "${activation_duration}block.minecraft.lightning_rod": "block.minecraft.lightning_rod",
    "${activation_duration}block.minecraft.mangrove_button": "block.minecraft.mangrove_button",
    "${activation_duration}block.minecraft.mangrove_pressure_plate": "block.minecraft.mangrove_pressure_plate",
    "${activation_duration}block.minecraft.oak_button": "block.minecraft.oak_button",
    "${activation_duration}block.minecraft.oak_pressure_plate": "block.minecraft.oak_pressure_plate",
    "${activation_duration}block.minecraft.pale_oak_button": "block.minecraft.pale_oak_button",
    "${activation_duration}block.minecraft.pale_oak_pressure_plate": "block.minecraft.pale_oak_pressure_plate",
    "${activation_duration}block.minecraft.polished_blackstone_button": "block.minecraft.polished_blackstone_button",
    "${activation_duration}block.minecraft.polished_blackstone_pressure_plate": "block.minecraft.polished_blackstone_pressure_plate",
    "${activation_duration}block.minecraft.spruce_button": "block.minecraft.spruce_button",
    "${activation_duration}block.minecraft.spruce_pressure_plate": "block.minecraft.spruce_pressure_plate",
    "${activation_duration}block.minecraft.stone_button": "block.minecraft.stone_button",
    "${activation_duration}block.minecraft.stone_pressure_plate": "block.minecraft.stone_pressure_plate",
    "${activation_duration}block.minecraft.target": "block.minecraft.target",
    "${activation_duration}block.minecraft.trapped_chest": "block.minecraft.trapped_chest",
    "${activation_duration}block.minecraft.tripwire_hook": "block.minecraft.tripwire_hook",
    "${activation_duration}block.minecraft.warped_button": "block.minecraft.warped_button",
    "${activation_duration}block.minecraft.warped_pressure_plate": "block.minecraft.warped_pressure_plate",
    "${discs}jukebox_song.minecraft.11": "jukebox_song.minecraft.11",
    "${discs}jukebox_song.minecraft.13": "jukebox_song.minecraft.13",
    "${discs}jukebox_song.minecraft.5": "jukebox_song.minecraft.5",
    "${discs}jukebox_song.minecraft.blocks": "jukebox_song.minecraft.blocks",
    "${discs}jukebox_song.minecraft.cat": "jukebox_song.minecraft.cat",
    "${discs}jukebox_song.minecraft.chirp": "jukebox_song.minecraft.chirp",
    "${discs}jukebox_song.minecraft.creator_music_box": "jukebox_song.minecraft.creator_music_box",
    "${discs}jukebox_song.minecraft.creator": "jukebox_song.minecraft.creator",
    "${discs}jukebox_song.minecraft.far": "jukebox_song.minecraft.far",
    "${discs}jukebox_song.minecraft.mall": "jukebox_song.minecraft.mall",
    "${discs}jukebox_song.minecraft.mellohi": "jukebox_song.minecraft.mellohi",
    "${discs}jukebox_song.minecraft.otherside": "jukebox_song.minecraft.otherside",
    "${discs}jukebox_song.minecraft.pigstep": "jukebox_song.minecraft.pigstep",
    "${discs}jukebox_song.minecraft.precipice": "jukebox_song.minecraft.precipice",
    "${discs}jukebox_song.minecraft.relic": "jukebox_song.minecraft.relic",
    "${discs}jukebox_song.minecraft.stal": "jukebox_song.minecraft.stal",
    "${discs}jukebox_song.minecraft.strad": "jukebox_song.minecraft.strad",
    "${discs}jukebox_song.minecraft.wait": "jukebox_song.minecraft.wait",
    "${discs}jukebox_song.minecraft.ward": "jukebox_song.minecraft.ward",
    "${jukebox}block.minecraft.jukebox": "block.minecraft.jukebox",
    "${sculk_both}block.minecraft.calibrated_sculk_sensor": "block.minecraft.calibrated_sculk_sensor",
    "${sculk_both}block.minecraft.sculk_sensor": "block.minecraft.sculk_sensor",
    "${sculk_chart}block.minecraft.calibrated_sculk_sensor": "block.minecraft.calibrated_sculk_sensor",
    "${sculk_chart}block.minecraft.sculk_sensor": "block.minecraft.sculk_sensor",
    "${sculk_duration}block.minecraft.calibrated_sculk_sensor": "block.minecraft.calibrated_sculk_sensor",
    "${sculk_duration}block.minecraft.sculk_sensor": "block.minecraft.sculk_sensor",
    "${ss_barrel}container.barrel": "container.barrel",
    "${ss_brewing}container.brewing": "container.brewing",
    "${ss_chest_minecart}entity.minecraft.chest_minecart": "entity.minecraft.chest_minecart",
    "${ss_chests}container.chest": "container.chest",
    "${ss_chests}container.chestDouble": "container.chestDouble",
    "${ss_decorated_pot}block.minecraft.decorated_pot": "block.minecraft.decorated_pot",
    "${ss_droppers}container.dispenser": "container.dispenser",
    "${ss_droppers}container.dropper": "container.dropper",
    "${ss_furnaces}container.blast_furnace": "container.blast_furnace",
    "${ss_furnaces}container.furnace": "container.furnace",
    "${ss_furnaces}container.smoker": "container.smoker",
    "${ss_hopper_minecart}entity.minecraft.hopper_minecart": "entity.minecraft.hopper_minecart",
    "${ss_hopper}container.hopper": "container.hopper",
    "${ss_shulker}container.shulkerBox": "container.shulkerBox",
    "condition": "false",
